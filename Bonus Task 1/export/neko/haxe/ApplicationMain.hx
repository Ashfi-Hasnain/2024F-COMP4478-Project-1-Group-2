...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Bonus Task 1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Bonus Task 1", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Bonus Task 1";
		app.meta["name"] = "Bonus Task 1";
