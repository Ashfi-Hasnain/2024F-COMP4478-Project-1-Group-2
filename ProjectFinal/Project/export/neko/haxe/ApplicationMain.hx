...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Project", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Project", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Project";
		app.meta["name"] = "Project";
