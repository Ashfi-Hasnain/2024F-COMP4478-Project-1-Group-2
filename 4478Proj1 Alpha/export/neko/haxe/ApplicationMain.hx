...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("4478Proj1 Alpha", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("4478Proj1 Alpha", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "4478Proj1 Alpha";
		app.meta["name"] = "4478Proj1 Alpha";
		...
		#elseif air
		app.window.title = "4478Proj1 Alpha";
		#else
